// Jdenticon 0.0.0 | jdenticon.com | zlib licensed | (c) 2014-2015 Daniel Mester Pirttijärvi
(function(h,k,g){var l=g(h,h.jQuery);"undefined"!==typeof module&&"exports"in module?module.exports=l:"function"===typeof define&&define.amd?define([],function(){return l}):h[k]=l})(this,"jdenticon",function(h,k){function g(b,a){this.x=b;this.y=a}function l(b,a,c,d){this.o=b;this.s=a;this.f=c;this.l=d}function A(b){this.C=b;this.m=l.O}function m(b){b|=0;return 0>b?"00":16>b?"0"+b.toString(16):256>b?b.toString(16):"ff"}function t(b,a,c){c=0>c?c+6:6<c?c-6:c;return m(255*(1>c?b+(a-b)*c:3>c?a:4>c?b+(a-
b)*(4-c):b))}function D(b,a){return[n.w(0,0,a.H(0)),n.v(b,a.A,a.u(.5)),n.w(0,0,a.H(1)),n.v(b,a.A,a.u(1)),n.v(b,a.A,a.u(0))]}function u(b,a,c,d,q){var f=0,v=0;function p(c,d,q,p,e){p=p?parseInt(a.charAt(p),16):0;d=d[parseInt(a.charAt(q),16)%d.length];b.F(n[m[c]]);for(c=0;c<e.length;c++)h.m=new l(f+e[c][0]*g,v+e[c][1]*g,g,p++%4),d(h,g,c);b.G()}function e(a){if(0<=a.indexOf(k))for(var b=0;b<a.length;b++)if(0<=m.indexOf(a[b]))return!0}d=c*(void 0===d?.08:d)|0;c-=2*d;if(30>c)throw Error("Jdenticon cannot render identicons smaller than 30 pixels.");
if(!/^[0-9a-f]{11,}$/i.test(a))throw Error("Invalid hash passed to Jdenticon.");var h=new A(b),g=0|c/4,f=f+(0|d+c/2-2*g),v=v+(0|d+c/2-2*g),n=D(parseInt(a.substr(-7),16)/268435455,q),m=[],k;for(c=0;3>c;c++){k=parseInt(a.charAt(8+c),16)%n.length;if(e([0,4])||e([2,3]))k=1;m.push(k)}p(0,w.J,2,3,[[1,0],[2,0],[2,3],[1,3],[0,1],[3,1],[3,2],[0,2]]);p(1,w.J,4,5,[[0,0],[3,0],[3,3],[0,3]]);p(2,w.N,1,null,[[1,1],[2,1],[2,2],[1,2]])}function B(){this.i=""}function x(b,a){this.j={};this.f={M:b,I:a}}function y(b,
a,c){this.h=b;b.clearRect(0,0,a,c)}function z(){function b(a,b,f){var e=c[a]instanceof Array?c[a]:[b,f];return function(a){a=e[0]+a*(e[1]-e[0]);return 0>a?0:1<a?1:a}}var a=e.config||h.jdenticon_config||{},c=a.lightness||{},a=a.saturation;return{A:"number"==typeof a?a:.5,u:b("color",.4,.8),H:b("grayscale",.3,.9)}}function r(b,a,c){if("string"===typeof b){if(C){b=document.querySelectorAll(b);for(var d=0;d<b.length;d++)r(b[d],a,c)}}else if(b&&b.tagName&&(a=a||b.getAttribute("data-jdenticon-hash"))){var q=
"svg"==b.tagName.toLowerCase(),d="canvas"==b.tagName.toLowerCase();if(q||d&&"getContext"in b){var d=Number(b.getAttribute("width"))||b.clientWidth||0,f=Number(b.getAttribute("height"))||b.clientHeight||0,e=q?new x(d,f):new y(b.getContext("2d"),d,f),g=Math.min(d,f);u(e,a,g,c,z());if(q){a=document.createElement("span");for(a.innerHTML=e.K(!1);b.firstChild;)b.removeChild(b.firstChild);for(a=a.firstChild.childNodes;a.length;)b.appendChild(a[0]);b.setAttribute("viewBox","0 0 "+d+" "+f)}}}}function e(){C&&
r("svg[data-jdenticon-hash],canvas[data-jdenticon-hash]")}l.prototype={L:function(b,a,c,d){var e=this.o+this.f,f=this.s+this.f;return 1===this.l?new g(e-a-(d||0),this.s+b):2===this.l?new g(e-b-(c||0),f-a-(d||0)):3===this.l?new g(this.o+a,f-b-(c||0)):new g(this.o+b,this.s+a)}};l.O=new l(0,0,0,0);A.prototype={a:function(b,a){var c=a?-2:2,d=this.m,e=[],f;for(f=a?b.length-2:0;f<b.length&&0<=f;f+=c)e.push(d.L(b[f],b[f+1]));this.C.a(e)},b:function(b,a,c,d){this.C.b(this.m.L(b,a,c,c),c,d)},c:function(b,
...
c;for(c in this.j)a+='<path fill="'+c+'" d="'+this.j[c].i+'"/>';return b?a:a+"</svg>"}};y.prototype={F:function(b){this.h.fillStyle=b;this.h.beginPath()},G:function(){this.h.fill()},a:function(b){var a=this.h,c;a.moveTo(b[0].x,b[0].y);for(c=1;c<b.length;c++)a.lineTo(b[c].x,b[c].y);a.closePath()},b:function(b,a,c){var d=this.h;a/=2;d.arc(b.x+a,b.y+a,a,0,2*Math.PI,c);d.closePath()}};var C="document"in h&&"querySelectorAll"in document;e.identicon=function(b,a,c){if(!b)throw Error("No canvas specified.");
b=new y(b,c,c);u(b,a,c,0,z())};e.toSvg=function(b,a,c){var d=new x(a,a);u(d,b,a,c,z());return d.K()};e.update=r;e.version="0.0.0";k&&(k.fn.jdenticon=function(b,a){this.each(function(c,d){r(d,b,a)});return this});"function"===typeof setTimeout&&setTimeout(e,0);return e});